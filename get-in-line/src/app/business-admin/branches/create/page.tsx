...
export default function CreateBranchPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`/api/businesses/${business.id}/branches`, {
        method: 'POST',
        headers: {
    ...
    return (
      <DashboardLayout>
        <div className="max-w-2xl mx-auto p-6">
          <Alert>
            <AlertDescription>
              Unable to load business information. Please make sure you're associated with a business.
            </AlertDescription>
          </Alert>
        </div>
      </DashboardLayout>
            ...
            <CardContent className="pt-6">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-4">
                  The branch "{formData.name}" has been added to {business.name}.
                </p>
                <p className="text-sm text-gray-500">
                  Redirecting back to business dashboard...
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <div className="max-w-2xl mx-auto p-6">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-2">
            Add a new branch to {business.name}
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {businessUsers.length > 0 && (
                <div className="space-y-2">
                  ...
                  <Select value={formData.managerId || undefined} onValueChange={(value) => handleInputChange('managerId', value)}>
                    <SelectTrigger>
                  ...
                  <p className="text-sm text-gray-500">
                    Select from all users associated with this business: owners, admins, and staff members.
                  </p>
                </div>
              )}
